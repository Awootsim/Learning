...
def letter_stat(our_str):
    """
    Создаем словарь, в котором ключ - буква из слова, значение - количество раз сколько буква встречается в слове
    :param our_str: Слово, которое переводим в словарь
    :return: Словарь, со значением "буква : количество раз сколько она встречается в слове"
    """
    letters_dict = {}
    for i in our_str:
